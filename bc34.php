...
$data->nama_pejabat = 'satu dua tiga empat lime enam tujuh';
...
$pdf->SetFont('Arial','I','10');
$pdf->Cell(0,5,'INFORMATION OF PASSENGER','LR',2,'L');
//data penumpang
//nama lengkap
$row_x = $pdf->GetX();
$row_y = $pdf->GetY();
...
$pdf->Cell(10, 4, "9. No", 0,0,'L');

$pdf->SetFont('Arial', '', 7);
$pdf->Cell(5, 4, "10.", 0,0,'L');
$pdf->multiCell(25, 4, "Uraian Jenis, Barang, Merek, Tipe, ukuran, Spesifikasi lain, Kode Barang", 0,'L');
$pdf->SetFont('Arial', 'I', 7);
$pdf->SetX($row_x+15);
$pdf->multiCell(25, 4, "Description of Goods, Marks, Type, Size, Other Specification, Item Code", 0,'L');

$pdf->SetFont('Arial', '', 7);
$pdf->SetXY($row_x+35+5,$row_y);
$pdf->Cell(5, 4, "10.", 0,0,'L');
$pdf->multiCell(20, 4, "Jumlah dan Jenis Kemasan", 0,'L');
$pdf->SetX($row_x+40+5);
$pdf->SetFont('Arial', 'I', 7);
$pdf->multiCell(20, 4, "Number and Type of Packages", 0,'L');

$pdf->SetFont('Arial', '', 7);
$pdf->SetXY($row_x+60+5,$row_y);
$pdf->Cell(5, 4, "12.", 0,0,'L');
$pdf->multiCell(20, 4, "Banyak Barang", 0,'L');
$pdf->SetX($row_x+65+5);
$pdf->SetFont('Arial', 'I', 7);
$pdf->multiCell(20, 4, "Amount of Goods", 0,'L');

$pdf->SetFont('Arial', '', 7);
$pdf->SetXY($row_x+60+25+5,$row_y);
$pdf->Cell(5, 4, "13.", 0,0,'L');
$pdf->multiCell(20, 4, "Berat Bruto", 0,'L');
$pdf->SetX($row_x+65+25+5);
$pdf->SetFont('Arial', 'I', 7);
$pdf->multiCell(20, 4, "Gross Weight", 0,'L');

$pdf->SetFont('Arial', '', 7);
$pdf->SetXY($row_x+60+25+25+5,$row_y);
$pdf->Cell(5, 4, "14.", 0,0,'L');
$pdf->multiCell(20, 4, "Harga Satuan", 0,'L');
$pdf->SetX($row_x+65+25+25+5);
$pdf->SetFont('Arial', 'I', 7);
$pdf->multiCell(20, 4, "Unit Price", 0,'L');

$pdf->SetFont('Arial', '', 7);
$pdf->SetXY($row_x+60+50+25+5,$row_y);
$pdf->Cell(5, 4, "15.", 0,0,'L');
$pdf->multiCell(20, 4, "Jumlah Harga", 0,'L');
$pdf->SetX($row_x+65+50+25+5);
$pdf->SetFont('Arial', 'I', 7);
$pdf->multiCell(20, 4, "Total Price", 0,'L');

$pdf->SetFont('Arial', '', 7);
$pdf->SetXY($row_x+60+75+25+5,$row_y);
$pdf->Cell(5, 4, "16.", 0,0,'L');
$pdf->multiCell(20, 4, "Keterangan", 0,'L');
$pdf->SetX($row_x+65+75+25+5);
$pdf->SetFont('Arial', 'I', 7);
$pdf->multiCell(20, 4, "Explanation", 0,'L');

//header table Rectangle data barang
$pdf->Rect($row_x, $row_y, 10, 40);
$pdf->Rect($row_x+10, $row_y, 30, 40);
$pdf->Rect($row_x+35+5, $row_y, 25, 40);
$pdf->Rect($row_x+60+5, $row_y, 25, 40);
$pdf->Rect($row_x+60+25+5, $row_y, 25, 40);
$pdf->Rect($row_x+60+25+25+5, $row_y, 25, 40);
$pdf->Rect($row_x+60+50+25+5, $row_y, 25, 40);
$pdf->Rect($row_x+60+75+25+5, $row_y, 25, 40);

//isi table Rectangle data barang
$pdf->Rect($row_x, $row_y+40, 10, 20);
$pdf->Rect($row_x+10, $row_y+40, 30, 20);
$pdf->Rect($row_x+35+5, $row_y+40, 25, 20);
$pdf->Rect($row_x+60+5, $row_y+40, 25, 20);
$pdf->Rect($row_x+60+25+5, $row_y+40, 25, 20);
$pdf->Rect($row_x+60+25+25+5, $row_y+40, 25, 20);
$pdf->Rect($row_x+60+50+25+5, $row_y+40, 25, 20);
$pdf->Rect($row_x+60+75+25+5, $row_y+40, 25, 20);


//Dokumen Pelengkap pabean
$pdf->SetY($row_y+40+25);
$pdf->SetFont('Arial','','10');
...
$pdf->Cell(10, 4, "17. No", 0,0,'L');

$pdf->SetFont('Arial', '', 7);
$pdf->Cell(5, 4, "18.", 0,0,'L');
$pdf->multiCell(80, 4, "Jenis Dokumen:", 0,'L');
$pdf->SetFont('Arial', 'I', 7);
$pdf->SetX($row_x+15);
$pdf->multiCell(80, 4, "Dokumen type", 0,'L');

$pdf->SetFont('Arial', '', 7);
$pdf->SetXY($row_x+90+5,$row_y);
$pdf->Cell(5, 4, "19.", 0,0,'L');
$pdf->multiCell(50, 4, "Nomor:", 0,'L');
$pdf->SetX($row_x+95+5);
$pdf->SetFont('Arial', 'I', 7);
$pdf->multiCell(50, 4, "Number", 0,'L');

$pdf->SetFont('Arial', '', 7);
$pdf->SetXY($row_x+90+5+55,$row_y);
$pdf->Cell(5, 4, "20.", 0,0,'L');
$pdf->multiCell(35, 4, "Tanggal:", 0,'L');
$pdf->SetX($row_x+95+5+50+5);
$pdf->SetFont('Arial', 'I', 7);
$pdf->multiCell(35, 4, "Date", 0,'L');
...
//isi table Rectangle data barang
$h_isidokpel = 20;
$pdf->Rect($row_x, $row_y+10, 10, $h_isidokpel);
$pdf->Rect($row_x+10, $row_y+10, 85, $h_isidokpel);
$pdf->Rect($row_x+35+60, $row_y+10, 55, $h_isidokpel);
$pdf->Rect($row_x+35+60+55, $row_y+10, 40, $h_isidokpel);
...
$pdf->SetY($pdf->GetY());
$pdf->SetFont('Arial','','8');
$pdf->Cell(0,5,'Dengan ini saya menyatakan bertanggung jawab atas kebenaran hal-hal yang diberitahukan dalam pemberitahuan ini.','LR',2,'L');
$pdf->SetFont('Arial','I','8');
...
$pdf->SetFont('Arial','','8');
$pdf->Cell(45,4,'Untuk Pejabat Bea dan Cukai',1,2,'L');
$pdf->SetFont('Arial','I','8');
$pdf->Cell(45,4,'For Customs Officer',1,2,'L');
$pdf->SetFont('Arial','','8');
$get_x = $pdf->GetX();
$get_y = $pdf->GetY();
$pdf->Cell(20,4,'Nama',1,2,'L');
$pdf->SetFont('Arial','I','8');
$pdf->Cell(45,4,'Name',1,2,'L');
$pdf->SetFont('Arial','','8');
$pdf->Cell(45,4,'NIP',0,2,'L'); 
$pdf->SetFont('Arial','I','8');
$pdf->Cell(45,4,'NIP',0,2,'L');
$pdf->SetFont('Arial','','8');
$pdf->Cell(45,4,'Tanda Tangan',0,2,'L'); 
$pdf->SetFont('Arial','I','8');
$pdf->Cell(45,4,'Signature',0,2,'L');
// $max_y = $pdf->GetY();

$pdf->SetXY($get_x+25, $get_y);
$pdf->SetFont('Arial','','8');
$pdf->Cell(45,4,$data->nama_pejabat,1,2,'L');
// $pdf->SetFont('Arial','','8');
// $pdf->MultiCell(95-$pdf->GetX(),4,$data->nama_pejabat,0,'L');
// $max_y = max($pdf->GetY(),$max_y);
...
// $pdf->SetFont('Arial','','8');
// $pdf->Cell(45,4,'Nama',0,2,'L'); 
// $pdf->SetFont('Arial','I','8');
// $pdf->Cell(45,4,'Name',0,2,'L');
// $pdf->SetFont('Arial','','8');
// $pdf->Cell(45,4,'NIP',0,2,'L'); 
// $pdf->SetFont('Arial','I','8');
// $pdf->Cell(45,4,'NIP',0,2,'L');
